...
def orange_right_dataset_transform(trajectory: Dict[str, Any]) -> Dict[str, Any]:
    # Data is already in standard format: action [7], state [7], language_instruction
    return trajectory
...
OXE_STANDARDIZATION_TRANSFORMS = {
    ...
    "libero_spatial_no_noops_10pct": libero_dataset_transform,
    "libero_spatial_no_noops_val10pct": libero_dataset_transform,
    ...
    ### Lift the basket (bimanual)
    "lift_the_basket": aloha_dataset_transform,
    ### Lift pot (bimanual, same format)
    "lift_pot": aloha_dataset_transform,
    ### Plate handover (bimanual)
    "plate_handover": aloha_dataset_transform,
    ### Close marker (bimanual)
    "close_marker": aloha_dataset_transform,
    ### Orange right arm picking dataset
    "orange_right": orange_right_dataset_transform,
}
