...
class PrismaticVLM(VLM):
    ...
    def from_pretrained(
        ...
        **kwargs,
        ...
        model_state_dict = torch.load(pretrained_checkpoint, map_location="cpu", weights_only=False)["model"]
        assert (
    ...
    def load_from_checkpoint(self, stage: str, run_dir: Path, pretrained_checkpoint: Optional[Path] = None) -> None:
        ...
        if pretrained_checkpoint is not None:
            ...
            model_state_dict = torch.load(pretrained_checkpoint, weights_only=False)["model"]
